...
eg.RegisterPlugin(
    ...
    guid="{3508932E-C6AE-4F1E-A352-69B929678A80}",
    author=u"jconic.com",
    version=u"0.5",
    kind=u"other",
    description=u"This plugin exposes certain actions of the Join for Android API to EventGhost.",
    icon=(
